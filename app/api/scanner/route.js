...
const FUNDAMENTALS = {
  ...
  LOW:  { name:'Lowe's Companies Inc.',           sector:'Cons. Disc.',      pe:22,  rev_growth:1,   margin:9,  roe:88,  debt_eq:8.80 },
  TGT:  { name:'Target Corporation',               sector:'Cons. Disc.',      pe:14,  rev_growth:1,   margin:4,  roe:28,  debt_eq:1.10 },
  MCD:  { name:'McDonald's Corporation',          sector:'Cons. Disc.',      pe:24,  rev_growth:2,   margin:32, roe:88,  debt_eq:8.80 },
